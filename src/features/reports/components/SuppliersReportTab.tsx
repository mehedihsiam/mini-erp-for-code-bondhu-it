...
import { supplierColumns } from "@/constants/reportColumns";
...
export function SuppliersReportTab() {
  ...
  const chartData = useMemo(() => groupByMonth(suppliers || [], "created_at"), [suppliers]);

  const onExport = useCallback(() => {
    handleExportCSV(suppliers || [], "suppliers_report");
  }, [suppliers]);
